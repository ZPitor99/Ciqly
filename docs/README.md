...
Toute personne réutilisant les données de la table Ciqual est seule responsable de cette réutilisation. Celle-ci ne doit pas induire en erreur des tiers quant au contenu des informations, leur source et leur date de mise à jour.
...
*Ce site est un projet indépendant de présentation des données Ciqual et n'est pas affilié à l'Anses.*